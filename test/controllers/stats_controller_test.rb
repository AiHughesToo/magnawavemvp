...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { mvpWins: @stat.mvpWins, nomsReceived: @stat.nomsReceived, nomsSent: @stat.nomsSent, userId: @stat.userId } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { mvpWins: @stat.mvpWins, nomsReceived: @stat.nomsReceived, nomsSent: @stat.nomsSent, userId: @stat.userId } }
